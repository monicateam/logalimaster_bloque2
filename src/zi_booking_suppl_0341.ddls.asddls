...
define view entity ZI_BOOKING_SUPPL_0341 as select from ztb_booksupl0341
   association to parent ZI_BOOKING_0341 as _TravelBooking on $projection.TravelID = _TravelBooking.TravelID and
                                                              $projection.BookingID = _TravelBooking.BookingID
